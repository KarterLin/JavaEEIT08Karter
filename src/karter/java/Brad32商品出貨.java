...
class Order1 extends Order {
	Order1(String orderId,int amount){  //要有建構式
		super(orderId,amount);
	}
	void process() {System.out.println("數位商品出貨了");}
}
class Order2 extends Order implements Shipable{  //Order2 can do ship
	Order2(String orderId,int amount){  //要有建構式
		super(orderId,amount);
	}
	void process() {
